...
public class HashBundleCreator_v13 extends HashBundleCreator implements Parcelable.ClassLoaderCreator<HashBundle> {

    @Override
    public HashBundle createFromParcel(Parcel source, ClassLoader loader) {
